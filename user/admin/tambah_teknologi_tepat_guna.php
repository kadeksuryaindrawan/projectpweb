                                        ...
                                        <div class="col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Tambah Teknologi Tepat Guna</h5>
                                                        <!--<span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span>-->
                                                    </div>
                                                    <div class="card-block">

                                                        <form class="form-material" method="POST" action="./process/tambah_teknologi_tepat_guna.process.php" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group form-default">
                                                            ...
                                                            <div class="form-group form-default">
                                                                ...
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Masukkan Judul</label>
                                                            </div>
