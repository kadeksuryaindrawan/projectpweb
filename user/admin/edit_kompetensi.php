                                        ...
                                        <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form class="form-material" method="POST" action="./process/edit_kompetensi.process.php" enctype="multipart/form-data">
                                                            <input type="hidden" name="id" value="<?= $id ?>">
                                                            <div class="form-group form-default">
                                                                <input type="number" name="nomor_sertif" class="form-control" required="" value="<?=$data['nomor_sertif']?>">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Masukkan Nomor Sertif</label>
                                                            </div>
                                                            <div class="form-group form-default">
                                                                ...
                                                                <div class="form-group form-default">
                                                                <input type="text" name="nama_sertif" class="form-control" required="" value="<?= $data['nama_sertif'] ?>">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Masukkan Nama Sertif</label>
                                                            </div> 

                                                            <div class="form-group form-default">
                                                                <label>Tanggal Berlaku</label>
                                                                <input type="date" name="tanggal_berlaku" class="form-control" required="" value="<?= $data['tanggal_berlaku'] ?>">
                                                                <span class="form-bar"></span>
                                                            </div>
