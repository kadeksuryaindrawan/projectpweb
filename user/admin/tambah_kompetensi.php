                                        ...
                                        <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <form class="form-material" method="POST" action="./process/tambah_kompetensi.process.php" enctype="multipart/form-data">
                                                        
                                                        <div class="form-group form-default">
                                                                <input type="number" name="nomor_sertif" class="form-control" required="">
                                                        ...
                                                        <div class="form-group form-default">
                                                            ...
                                                            <div class="form-group form-default">
                                                                <input type="text" name="nama_sertif" class="form-control" required="">
                                                                <span class="form-bar"></span>
