                                                            ...
                                                            <div class="form-group form-default">
                                                                ...
                                                                <label>Pilih Mahasiswa</label>
                                                                    <select name="nim" id="" class="form-control" required>
                                                                        ...
                                                                        <?php 
                                                                        $query_dos = mysqli_query($connection, "SELECT * FROM mahasiswa ORDER BY nim ASC");
                                                                        if(mysqli_num_rows($query_dos) > 0){
                                                                            while($data_dos = mysqli_fetch_assoc($query_dos)) {
                                                                                if($data['nim'] == $data_dos['nim']){
                                                                                    $isSelected = "Selected";
                                                                                }
                                                                                else{
                                                                                    $isSelected = "";
                                                                            ...
                                                                            ?>
                                                                                <option value="<?= $data_dos['nim'] ?>" <?= $isSelected ?> ><?= ucwords($data_dos['nama_mahasiswa']) ?></option>
                                                                            <?php
                                                                            }
                                                                        }
                                                                        else{
