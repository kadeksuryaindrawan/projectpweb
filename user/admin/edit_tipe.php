                                        ...
                                        <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form class="form-material" method="POST" action="./process/edit_tipe.process.php">
                                                            <input type="hidden" name="id" value="<?= $id ?>">
                                                            <div class="form-group form-default">
                                                                <input type="text" name="nama_tipe" class="form-control" required="" value="<?= $data['nama_tipe'] ?>">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Masukkan Nama Tipe</label>
                                                            </div>
