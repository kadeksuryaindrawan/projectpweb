                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                        <?php
                                                            $query = mysqli_query($connection, "SELECT penelitian.*,dosen.* FROM penelitian INNER JOIN dosen USING(nip) ORDER BY penelitian.id_penelitian DESC");
                                                            $nomor = 1;
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <?php
                                                                            if($data['status'] == 'belum terverifikasi'){
                                                                                ?>
                                                                                    <a class="text-success" href="./verifikasi_penelitian.php?id=<?php echo $data['id_penelitian'] ?>" onclick = "return confirm('Yakin verifikasi penelitian?')"><button class="btn btn-success waves-effect waves-light" style="margin-bottom:15px;">Verifikasi</button></a>
                                                                                <?php
                                                                            }
                                                                        ?>
                                                                        </td>
