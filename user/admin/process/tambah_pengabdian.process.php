            ...
            if(mysqli_num_rows($query_check) == 0){
                if($dana > 0){
                    if($tipe_proposal == "application/pdf" && $tipe_laporan == "application/pdf"){
                            ...
                            $query_insert = mysqli_query($connection,"INSERT INTO pengabdian VALUES (NULL,'$nama_pengabdian','$tgl_pengabdian','$tempat_pengabdian','$nip',$dana,'$sumber_dana',NULL,NULL,'terverifikasi')");
