<?php  
	...
	if(isset($_POST['submit'])){
		extract($_POST);
		if(!empty($nip) && !empty($tahun) && !empty($pendidikan_prodi) && !empty($pendidikan_prodi_lain) && !empty($pendidikan_pt_luar) && !empty($penelitian) && !empty($pkm) && !empty($penunjang) && is_numeric($id)){
