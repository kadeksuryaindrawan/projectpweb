                                        ...
                                        <div class="col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Tambah Pembimbing Utama</h5>
                                                        <!--<span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span>-->
                                                    </div>
                                                    <div class="card-block">

                                                        <form class="form-material" method="POST" action="./process/tambah_pembimbing_utama.process.php" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group form-default">
                                                                ...
                                                                <label>Pilih Prodi</label>
                                                                    <select name="kode_prodi" id="" class="form-control" required>
                                                                        ...
                                                                        <?php
                                                                            $query = mysqli_query($connection,"SELECT * FROM prodi ORDER BY kode_prodi ASC");
                                                                            if(mysqli_num_rows($query) > 0){
                                                                                while($data = mysqli_fetch_assoc($query)){
                                                                                    ?>
                                                                                        <option value="<?= $data['kode_prodi'] ?>"><?= ucwords($data['nama_prodi']) ?></option>
                                                                                    <?php
                                                                                }
                                                                            }
                                                                        ?>
                                                            ...
                                                            <div class="form-group form-default">
                                                                <input type="number" name="jumlah_bimbingan" class="form-control" required="">
                                                                <span class="form-bar"></span>
