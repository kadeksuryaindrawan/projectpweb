                                        ...
                                        <div class="col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Tambah Publikasi Mahasiswa</h5>
                                                        <!--<span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span>-->
                                                    </div>
                                                    <div class="card-block">

                                                        <form class="form-material" method="POST" action="./process/tambah_publikasimhs.process.php" enctype="multipart/form-data">
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            if(mysqli_num_rows($query) > 0){
                                                                                while($data = mysqli_fetch_assoc($query)){
                                                                                    ?>
                                                                                        <option value="<?= $data['nim'] ?>"><?= ucwords($data['nama_mahasiswa']) ?></option>
                                                                                    <?php
                                                                                }
                                                                            }
                                                                        ?>
