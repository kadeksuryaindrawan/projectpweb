                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                        <?php
                                                            $query = mysqli_query($connection, "SELECT publikasi_mhs.*,mahasiswa.* FROM publikasi_mhs INNER JOIN mahasiswa USING(nim) ORDER BY publikasi_mhs.id_publikasimhs DESC");
                                                            $nomor = 1;
