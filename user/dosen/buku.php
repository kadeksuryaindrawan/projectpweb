                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                        <?php
                                                            $query = mysqli_query($connection, "SELECT publikasi_buku.*,dosen.* FROM publikasi_buku INNER JOIN dosen USING(nip) WHERE publikasi_buku.nip = $nip ORDER BY publikasi_buku.id_publikasibuku DESC");
                                                            $nomor = 1;
