                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                        <?php
                                                            $query = mysqli_query($connection, "SELECT haki_dosen.*,dosen.* FROM haki_dosen INNER JOIN dosen USING(nip) WHERE haki_dosen.nip = $nip ORDER BY haki_dosen.id_hakidosen DESC");
                                                            $nomor = 1;
