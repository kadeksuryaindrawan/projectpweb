                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                        <?php
                                                            $query = mysqli_query($connection, "SELECT pengabdian.*,dosen.* FROM pengabdian INNER JOIN dosen USING(nip) WHERE pengabdian.nip = $nip ORDER BY pengabdian.id_pengabdian DESC");
                                                            $nomor = 1;
