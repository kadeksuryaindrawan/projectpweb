                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                        <?php
                                                            $query = mysqli_query($connection, "SELECT penelitian.*,dosen.* FROM penelitian INNER JOIN dosen USING(nip) WHERE penelitian.nim = $nim ORDER BY penelitian.id_penelitian DESC");
                                                            $nomor = 1;
