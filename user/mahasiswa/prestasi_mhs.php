                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                        <?php
                                                            $query = mysqli_query($connection, "SELECT prestasi_mhs.*,mahasiswa.* FROM prestasi_mhs INNER JOIN mahasiswa USING(nim) WHERE prestasi_mhs.nim = $nim ORDER BY prestasi_mhs.id_prestasi DESC");
                                                            $nomor = 1;
