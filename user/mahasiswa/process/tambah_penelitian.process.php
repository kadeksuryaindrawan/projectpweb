                ...
                if($tahun_penelitian > 0){
                    if($dana > 0){
                        if($tipe_proposal == "application/pdf" && $tipe_laporan == "application/pdf"){
                                ...
                                $query_insert = mysqli_query($connection,"INSERT INTO penelitian VALUES (NULL,'$judul_penelitian','$tahun_penelitian','$tempat_penelitian','$nip','$anggota',$dana,'$sumber_dana',NULL,NULL,'belum terverifikasi','$nim')");
