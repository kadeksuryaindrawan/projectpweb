...
<html lang="en">
<?php
    $mahasiswa_id = $_SESSION['user_login']['mahasiswa_id'];
    $query = mysqli_query($connection,"SELECT * FROM mahasiswa WHERE user_id = $mahasiswa_id");
    $data_mahasiswa = mysqli_fetch_assoc($query);
    $nim = $data_mahasiswa['nim'];
?>

<head>
    <title>ProdiKU - Mahasiswa</title>
                          ...
                          <div class="">
                              <div class="main-menu-header">
                                  ...
                                  <div class="user-details">
                                      <span id="more-details"><?= $data_mahasiswa['nama_mahasiswa'] ?><i class="fa fa-caret-down"></i></span>
                                  </div>
                              </div>
