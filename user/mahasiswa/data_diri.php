...
$page = 'dashboard';
    include "./partials/atas.php";
        $query_check = mysqli_query($connection, "SELECT users.*,mahasiswa.* FROM users INNER JOIN mahasiswa USING(user_id) WHERE users.user_id = $mahasiswa_id");
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form class="form-material" method="POST" action="./process/edit_datadiri.process.php">
                                                            <input type="hidden" name="user_id" value="<?= $mahasiswa_id ?>">
                                                            ...
                                                            <div class="form-group form-default">
                                                                <input type="number" name="nim" class="form-control" required="" value="<?= $data['nim'] ?>">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">NIM</label>
                                                            </div> 

                                                            <div class="form-group form-default">
                                                                <input type="text" name="nama_mahasiswa" class="form-control" required="" value="<?= $data['nama_mahasiswa'] ?>">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Nama Mahasiswa</label>
                                                            </div> 
