<?php
    ...
    session_start();
    if(!isset($_SESSION['user_login']['guest_id'])){
...
<html lang="en">
<?php
    $guest_id = $_SESSION['user_login']['guest_id'];
    $query = mysqli_query($connection,"SELECT * FROM users WHERE user_id = $guest_id");
    $data_guest = mysqli_fetch_assoc($query);
?>

<head>
    <title>ProdiKU - Guest</title>
                          ...
                          <div class="">
                              <div class="main-menu-header">
                                  ...
                                  <div class="user-details">
                                      <span id="more-details">Guest<i class="fa fa-caret-down"></i></span>
                                  </div>
                              </div>
