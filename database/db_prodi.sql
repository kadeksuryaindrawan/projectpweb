...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 04, 2022 at 07:06 PM
...
INSERT INTO `dosen` (`nip`, `nidn`, `nama_dosen`, `alamat`, `no_telp`, `user_id`, `prodi`) VALUES
('237238732', '32872873827', 'Gilang', 'DPS', '29389283', 18, 2331212),
('323280238', '12345678', 'Pak Chandra', 'Kuta', '0823723821', 9, 2321232),
('6152738712', '231232332', 'Pak Eddy', 'DPS', '089754789237', 8, 889273),
('72637263271', '7823782281', 'dosen test', 'Denpasar', '08782372812', 16, 736482);
...
INSERT INTO `haki_dosen` (`id_hakidosen`, `nip`, `judul_haki`, `tgl_terdaftar`, `no_haki`, `file_sertif`, `anggota`) VALUES
(3, '323280238', 'HAKI TEST', '2022-01-14', 22, 'haki_dosen_323280238_3.pdf', 'surya indrawan'),
(5, '6152738712', 'HAKI BERTAHAN HIDUP', '2022-02-17', 23321212, 'haki_dosen_6152738712_5.pdf', 'wadwadwadwa');
...
(3, 'Penelitian Bunga Anggrek', 2021, 'Denpasar', '323280238', 'Surya Indrawan', 2000000, 'DRPMDIKTI', 'penelitian_proposal_323280238_3.pdf', 'penelitian_laporan_323280238_3.pdf', 'terverifikasi', NULL),
(4, 'Penelitian Bunga Mawar', 2018, 'Ubud', '6152738712', 'Surya Riski', 5000000, 'SWADANA', 'penelitian_proposal_6152738712_4.pdf', 'penelitian_laporan_6152738712_4.pdf', 'belum terverifikasi', NULL),
(7, 'Penelitian Anak', 2022, 'Denpasar', '323280238', 'Surya Indrawan', 1000000, 'SWADANA', 'penelitian_proposal_323280238_7.pdf', 'penelitian_laporan_323280238_7.pdf', 'belum terverifikasi', '2015354007'),
(8, 'Penelitian Contoh', 2022, 'Denpasar', '323280238', 'surya kadek', 5000000, 'DRPMDIKTI', 'penelitian_proposal_323280238_8.pdf', 'penelitian_laporan_323280238_8.pdf', 'belum terverifikasi', '2015354008');
...
(1, 'Pengabdian desa pemogan', '2022-01-15', 'Denpasar', '72637263271', 2000000, 'DIPA', 'pengabdian_proposal_72637263271_1.pdf', 'pengabdian_laporan_72637263271_1.pdf', 'terverifikasi'),
(4, 'Pengabdian Biasa', '2022-01-29', 'Denpasar', '6152738712', 4000000, 'SWADANA', 'pengabdian_proposal_6152738712_4.pdf', 'pengabdian_laporan_6152738712_4.pdf', 'belum terverifikasi'),
...
INSERT INTO `peringkat_jurnal` (`id_peringkatjurnal`, `id_jurnalindex`, `nama_peringkatjurnal`) VALUES
(1, 1, 'sinta 1'),
(2, 1, 'sinta 2'),
(3, 3, 'q 1'),
(4, 3, 'q 2'),
...
INSERT INTO `prodi` (`kode_prodi`, `nama_prodi`, `nip_kaprodi`) VALUES
(736482, 'D4 TEST', '72637263271'),
(889273, 'D4 TRPL', '6152738712'),
(2321232, 'D3 Manajemen Informatika', '323280238'),
(2331212, 'D4 Teknik Otomasi', '');
...
INSERT INTO `publikasi_buku` (`id_publikasibuku`, `nip`, `penulis_buku`, `judul_buku`, `penerbit`, `tahun_terbit`, `status`) VALUES
(1, '6152738712', 'surya indrawan, surya kadek', 'Laskar Pelangi', 'gramedia', 2020, 'belum terverifikasi'),
(3, '323280238', 'saya sendiri', 'Sang Pemimpi', 'gramedia', 2019, 'terverifikasi');
...
INSERT INTO `publikasi_dosen` (`id_publikasidosen`, `nip`, `judul_jurnal`, `nama_jurnal`, `id_jurnalindex`, `peringkat_jurnal`, `tgl_publish`, `institusi_penerbit`, `file_jurnal`) VALUES
(3, '6152738712', 'Jurnal TRPL', 'TRPL Jurnal', 1, 7, '2022-02-22', 'Politeknik Negeri Bali', 'publikasi_dosen_6152738712_3.pdf'),
(5, '323280238', 'Jurnal Pak Chandra', 'Pak Chandra punya', 1, 2, '2022-02-22', 'Politeknik Negeri Bali', 'publikasi_dosen_323280238_5.pdf');
...
--
ALTER TABLE `haki_dosen`
  MODIFY `id_hakidosen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `jurnal_index`
  MODIFY `id_jurnalindex` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `publikasi_dosen`
  MODIFY `id_publikasidosen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
